  ...
  return (
    <div className='customer-reviews-section bg-[#F5DFBD] py-[44px] mt-[80px]'>
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[64px] items-center mx-0 md:mx-[30px]">
            ...
            >
              <SwiperSlide>
                <div className='item'>
                  ...
                  <p className='text-[16px] md:text-[24px]'>I never thought shopping online could be this enjoyable.  it's organized, and every click feels purposeful. Finally, an ecommerce experience that feels as good as it looks!</p>
